...
const VIEW_TITLES: Record<View, { eyebrow: string; title: string; description: string }> = {
  ...
  mindMap: { eyebrow: "See the whole orbit", title: "Mind Map", description: "A live, interactive 3D view of every task, branching from the goals it supports." },
...
export default function Home({ initialView = "today", initialProjectId = null, initialProjectFilter = [] }: { initialView?: View; initialProjectId?: string | null; initialProjectFilter?: string[] }) {
  ...
  const navItems: { view: View; label: string; icon: typeof LayoutDashboard; count?: number }[] = [
    ...
    { view: "mindMap", label: "Mind Map", icon: Network, count: tasks.length },
